...
local date_time "200423_1500"
local date_time "200423_2130"
}
...
putexcel set "${scratch}Ftest_`date_time'.xls", replace sheet(Sheet1)
...
putexcel set "${scratch}Ftest_`date_time'.xls", modify sheet(Sheet2)

local col = 2
local row = 2


foreach var in pre3 pre2 node_reassigned post1 post2 post3	{
	...
	test d1_`var'_re_year_2000 d1_`var'_re_year_2001 d1_`var'_re_year_2002 d1_`var'_re_year_2003 d1_`var'_re_year_2004 d1_`var'_re_year_2006 d1_`var'_re_year_2007 d1_`var'_re_year_2008 d1_`var'_re_year_2009 d1_`var'_re_year_2010


	local Fval = round(r(F), .00001)
	local Pval = round(r(p), .00001)
